		...
		<section class="container">
			...
			<div class="collapse show" id="profil">
				...
				<div class="card card-body">
					<!-- formulaire gestion avatar membre -->
				    ...
				    <!-- formulaire gestion profil membre -->
			                ...
			                <table class="table table-striped">
			                    ...
			                    <tbody>
				                    ...
				                    <tr>
				                        ...
				                        <td>
				                        	<?php
				                        	if ( !$annonce['validated']) : // on supprime icon grisé si elle n'est pas validé
				                        	?>
			...
			<!-- Affichage de la liste des messages du membre -->
